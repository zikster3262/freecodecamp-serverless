...
resource "aws_apigatewayv2_route" "api-subtypes" {
  api_id     = aws_apigatewayv2_api.api-gw.id
  route_key  = "GET /subtypes"
  depends_on = [aws_apigatewayv2_api.api-gw]
  target     = "integrations/${aws_apigatewayv2_integration.api-gw.id}"
}

resource "aws_apigatewayv2_route" "api-formats" {
  api_id     = aws_apigatewayv2_api.api-gw.id
  route_key  = "GET /formats"
  depends_on = [aws_apigatewayv2_api.api-gw]
  target     = "integrations/${aws_apigatewayv2_integration.api-gw.id}"
}

resource "aws_apigatewayv2_route" "api-supertypes" {
  api_id     = aws_apigatewayv2_api.api-gw.id
  route_key  = "GET /supertypes"
  depends_on = [aws_apigatewayv2_api.api-gw]
  target     = "integrations/${aws_apigatewayv2_integration.api-gw.id}"
}

resource "aws_apigatewayv2_route" "api-gw-id" {
  api_id     = aws_apigatewayv2_api.api-gw.id
...
resource "aws_apigatewayv2_route" "sets" {
  api_id     = aws_apigatewayv2_api.api-gw.id
  route_key  = "GET /sets"
  depends_on = [aws_apigatewayv2_api.api-gw]
  target     = "integrations/${aws_apigatewayv2_integration.api-gw.id}"
...
resource "aws_apigatewayv2_route" "sets-id" {
  api_id     = aws_apigatewayv2_api.api-gw.id
  route_key  = "GET /sets/{word}"
  depends_on = [aws_apigatewayv2_api.api-gw]
  target     = "integrations/${aws_apigatewayv2_integration.api-gw.id}"
}
